...
f1a <- ggplot(df, aes(xmin = left, xmax = right, ymin = down, ymax = up))+
    ...
    annotate("rect", xmin = c(15, 37.5), xmax = c(37.5, 82.5), ymin = 5.5, ymax = 7, 
             fill = c("#56B4E9", "orange"))+
    annotate("segment", x = 82.5, xend = 82.5, y = 5.5, yend = 7, color = "red")+
    annotate("rect", xmin = 0, xmax = 97.5, ymin = 5.5, ymax = 7, 
             color = "black", alpha = 0)+
    ...
    annotate("rect", xmin = c(66.5, 74), xmax = c(74, 119), ymin = -7, ymax = -5.5, 
             fill = c("#56B4E9", "orange"))+
    annotate("segment", x = 119, xend = 119, y = -5.5, yend = -7, lty = 6, 
             size = 0.7, color = "red")+
    annotate("rect", xmin = 51.5, xmax = 122, ymin = -7, ymax = -5.5, 
             color = "black", alpha = 0)+
...
f1b <- ggplot(training, aes(Time, Mean))+
    ...
    annotate("rect", xmin = seq(0, length.out = 7, by = 260), 
             xmax = seq(65, length.out = 7, by = 260), ymin = -10, ymax = 100, 
             color = "black", alpha = 0, size = 0.2)+
    geom_smooth(span = 0.1, se = TRUE)+
    geom_point(size = 0.5)+
    annotate("rect", xmin = c(280, 700), xmax = c(700, 1540), ymin = 130, ymax = 160, 
             fill = c("#56B4E9", "orange"))+
    annotate("segment", x = 1540, xend = 1540, y = 130, yend = 160, color = "red")+
    annotate("rect", xmin = 0, xmax = 1820, ymin = 130, ymax = 160, 
             color = "black", alpha = 0)+
    annotate("text", x = c(490, 1120, 1540), y = 170, label = c("Tone", "Trace", "Shock"),
             color = c("#56B4E9", "orange", "red"), size = 3)+
    ...
    annotate("text", x = seq(30, length.out = 7, by = 260), y = -18, 
             label = 1:7, size = 3)+
...
cbPalette <- c("#0072B2", "#CC79A7", "#009E73", "#F0E442")
f1c <- ggplot(test, aes(Time, Freezing, color = Test))+
    ...
    annotate("rect", xmin = seq(0, length.out = 5, by = 170), 
             xmax = seq(47, length.out = 5, by = 170), ymin = -10, ymax = 50, 
             color = "black", alpha = 0, size = 0.2)+
    geom_smooth(aes(group = Test), span = 0.1, size = 0.5)+
    geom_point(size = 0.5)+
    annotate("rect", xmin = c(181, 271), xmax = c(271, 814), ymin = 70, ymax = 84, 
             fill = c("#56B4E9", "orange"))+
    annotate("segment", x = 814, xend = 814, y = 70, yend = 84, lty = 6, 
             size = 0.7, color = "red")+
    annotate("rect", xmin = 0, xmax = 850, ymin = 70, ymax = 84,
             color = "black", alpha = 0)+
...
ggsave(figure1, filename = "figure 1.pdf", height = 17, width = 11.6, units = "cm")
