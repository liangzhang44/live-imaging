...
training.late2$trace <- ifelse(training.late2$trace.mean > 10*p, "Trace Cells", "Non-Trace Cells")

# figure 4a
col <- colorRamp2(c(1, 0, -1), brewer.pal(3, "RdYlBu"))
png("new figure 4a.png", height = 1200, width = 600)
hm1 <- Heatmap(training.late2[,2:177],col = col, show_heatmap_legend = FALSE,
...
ggsave(figure4, filename = "new figure 4.png", height = 8, width = 20)
